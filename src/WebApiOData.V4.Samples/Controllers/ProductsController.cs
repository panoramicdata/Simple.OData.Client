...
public class ProductsController : ODataController
{
	...
	[Route("*")]
	public IHttpActionResult Default() => Ok("OK!!!");

	[EnableQuery]
	public IQueryable<Product> Get() => _data.Values.AsQueryable();
	...
	public IHttpActionResult GetSalesTaxRate([FromODataUri] string state) => Ok(GetRate(state));
