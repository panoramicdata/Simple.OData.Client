...
namespace PanoramicData.OData.ProductService.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<ProductServiceContext>
    {
        ...
        protected override void Seed(global::PanoramicData.OData.ProductService.Models.ProductServiceContext context)
        {
            // New code 
