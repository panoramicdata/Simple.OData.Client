...
public class ResponseReader : ResponseReaderBase
{
	...
	public override Task<ODataResponse> GetResponseAsync(HttpResponseMessage responseMessage) => GetResponseAsync(new ODataResponseMessage(responseMessage));
	...
	private ODataFeedAnnotations CreateAnnotations(ODataResourceSetBase feed) => new()
	{
	...
	private ODataMediaAnnotations CreateAnnotations(ODataStreamReferenceValue value) => value == null ? null : new ODataMediaAnnotations
	{
