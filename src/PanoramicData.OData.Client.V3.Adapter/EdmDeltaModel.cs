...
internal class EdmDeltaModel : IEdmModel
{
	...
	public IEdmEntityContainer FindDeclaredEntityContainer(string name) => _source.FindDeclaredEntityContainer(name);
	public IEnumerable<IEdmFunction> FindDeclaredFunctions(string qualifiedName) => _source.FindDeclaredFunctions(qualifiedName);
	public IEdmValueTerm FindDeclaredValueTerm(string qualifiedName) => _source.FindDeclaredValueTerm(qualifiedName);
