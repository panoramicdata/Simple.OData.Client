...
public class Metadata : MetadataBase
{
	...
	public override bool EntityCollectionRequiresOptimisticConcurrencyCheck(string collectionName) => GetEntityType(collectionName).StructuralProperties()
	...
	public override bool IsOpenType(string collectionName) => GetEntityType(collectionName).IsOpen;
	...
	public override IEnumerable<string> GetStructuralPropertyNames(string collectionName) => GetEntityType(collectionName).StructuralProperties().Select(x => x.Name);

	public override bool HasStructuralProperty(string collectionName, string propertyName) => GetEntityType(collectionName).StructuralProperties().Any(x => NameMatchResolver.IsMatch(x.Name, propertyName));

	public override string GetStructuralPropertyExactName(string collectionName, string propertyName) => GetStructuralProperty(collectionName, propertyName).Name;
	...
	public override bool HasNavigationProperty(string collectionName, string propertyName) => GetEntityType(collectionName).NavigationProperties().Any(x => NameMatchResolver.IsMatch(x.Name, propertyName));

	public override string GetNavigationPropertyExactName(string collectionName, string propertyName) => GetNavigationProperty(collectionName, propertyName).Name;
	...
	public override IEnumerable<string> GetNavigationPropertyNames(string collectionName) => GetEntityType(collectionName).NavigationProperties().Select(x => x.Name);
	...
	public override IEnumerable<IEnumerable<string>> GetAlternateKeyPropertyNames(string collectionName) => Enumerable.Empty<IEnumerable<string>>();
	...
	public override string GetActionFullName(string actionName) => GetFunctionFullName(actionName);

	public override EntityCollection GetActionReturnCollection(string actionName) => GetFunctionReturnCollection(actionName);

	private IEnumerable<IEdmEntitySet> GetEntitySets() => _model.SchemaElements
	...
	private IEnumerable<IEdmEntityType> GetEntityTypes() => _model.SchemaElements
