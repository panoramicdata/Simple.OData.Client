...
public static class MemberInfoExtensions
{
	...
	public static bool IsNotMapped(this MemberInfo memberInfo) => MappingInfo(memberInfo).IsNotMapped;
	...
	/// <returns></returns>
	public static string GetMappedName(this MemberInfo memberInfo) => MappingInfo(memberInfo).MappedName;
	...
	public static object GetValueEx(this MemberInfo memberInfo, object instance) => MemberAccessor.GetValue(instance, memberInfo);

	public static void SetValueEx(this MemberInfo memberInfo, object instance, object value) => MemberAccessor.SetValue(instance, memberInfo, value);
}
