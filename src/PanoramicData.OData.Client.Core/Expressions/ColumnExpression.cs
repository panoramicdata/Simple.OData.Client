...
internal static class ColumnExpression
{
	...
	public static string ExtractColumnName(this Expression expression, ITypeCache typeCache) => expression.ExtractColumnNames(typeCache).Single();

	public static IEnumerable<string> ExtractColumnNames(this Expression expression, ITypeCache typeCache) => expression.NodeType switch
	{
	...
	private static IEnumerable<string> ExtractColumnNames(NewExpression newExpression, ITypeCache typeCache) => newExpression.Arguments.SelectMany(x => ExtractColumnNames(x, typeCache));
