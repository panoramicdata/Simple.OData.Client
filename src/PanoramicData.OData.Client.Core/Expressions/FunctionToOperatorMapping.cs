...
internal class InOperatorMapping : FunctionToOperatorMapping
{
	...
	protected override bool CanMap(string functionName, int argumentCount, ODataExpression functionCaller, AdapterVersion adapterVersion = AdapterVersion.Any) => functionName == nameof(Enumerable.Contains) &&
			   argumentCount == 1 &&
