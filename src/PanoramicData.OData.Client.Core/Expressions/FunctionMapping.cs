...
internal class FunctionMapping
{
	...
	public static bool ContainsFunction(string functionName, int argumentCount) => DefinedFunctions.Any(x => x.FunctionCall.Equals(new ExpressionFunction.FunctionCall(functionName, argumentCount)));
