...
public abstract class ResponseReaderBase : IResponseReader
{
	...
	protected void StartFeed(Stack<ResponseNode> nodeStack, ODataFeedAnnotations feedAnnotations) => nodeStack.Push(new ResponseNode
	{
	...
	protected void StartEntry(Stack<ResponseNode> nodeStack) => nodeStack.Push(new ResponseNode
	{
	...
	protected void StartNavigationLink(Stack<ResponseNode> nodeStack, string linkName) => nodeStack.Push(new ResponseNode
	{
		LinkName = linkName,
	});
