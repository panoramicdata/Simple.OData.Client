...
{
    private const string AdapterV3AssemblyName = "PanoramicData.OData.Client.V3.Adapter";
    private const string AdapterV4AssemblyName = "PanoramicData.OData.Client.V4.Adapter";
    private const string AdapterV3TypeName = "PanoramicData.OData.Client.V3.Adapter.ODataAdapter";
    private const string AdapterV4TypeName = "PanoramicData.OData.Client.V4.Adapter.ODataAdapter";
    private const string ModelAdapterV3TypeName = "PanoramicData.OData.Client.V3.Adapter.ODataModelAdapter";
    private const string ModelAdapterV4TypeName = "PanoramicData.OData.Client.V4.Adapter.ODataModelAdapter";
