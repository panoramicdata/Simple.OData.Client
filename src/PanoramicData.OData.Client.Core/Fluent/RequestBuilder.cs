...
internal class RequestBuilder : IRequestBuilder
{
	...
	private string FormatEntryKey(string collection, IDictionary<string, object> entryKey) => new ResolvedCommand(
			new FluentCommand(
    ...
    where T : class
{
	...
	public Task<IClientWithRequest<T>> FindEntriesAsync() => FindEntriesAsync(false, CancellationToken.None);

	public Task<IClientWithRequest<T>> FindEntriesAsync(CancellationToken cancellationToken) => FindEntriesAsync(false, cancellationToken);

	public Task<IClientWithRequest<T>> FindEntriesAsync(bool scalarResult) => FindEntriesAsync(scalarResult, CancellationToken.None);
	...
	public Task<IClientWithRequest<T>> FindEntriesAsync(ODataFeedAnnotations annotations) => FindEntriesAsync(annotations, CancellationToken.None);
	...
	public Task<IClientWithRequest<T>> FindEntryAsync() => FindEntryAsync(CancellationToken.None);
	...
	public Task<IClientWithRequest<T>> InsertEntryAsync() => InsertEntryAsync(true, CancellationToken.None);

	public Task<IClientWithRequest<T>> InsertEntryAsync(bool resultRequired) => InsertEntryAsync(resultRequired, CancellationToken.None);

	public Task<IClientWithRequest<T>> InsertEntryAsync(CancellationToken cancellationToken) => InsertEntryAsync(true, cancellationToken);
	...
	public Task<IClientWithRequest<T>> UpdateEntryAsync() => UpdateEntryAsync(true, CancellationToken.None);

	public Task<IClientWithRequest<T>> UpdateEntryAsync(bool resultRequired) => UpdateEntryAsync(resultRequired, CancellationToken.None);

	public Task<IClientWithRequest<T>> UpdateEntryAsync(CancellationToken cancellationToken) => UpdateEntryAsync(true, cancellationToken);
	...
	public Task<IClientWithRequest<T>> DeleteEntryAsync() => DeleteEntryAsync(CancellationToken.None);
