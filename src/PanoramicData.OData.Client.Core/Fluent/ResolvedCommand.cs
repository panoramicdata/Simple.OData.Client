...
public class ResolvedCommand
{
	...
	public string Format() => _sesson.Adapter.GetCommandFormatter().FormatCommand(this);
	...
	private bool TryExtractKeyFromNamedValues(IDictionary<string, object> namedValues, out IEnumerable<KeyValuePair<string, object>> matchingNamedKeyValues) => Utils.NamedKeyValuesContainKeyNames(namedValues,
