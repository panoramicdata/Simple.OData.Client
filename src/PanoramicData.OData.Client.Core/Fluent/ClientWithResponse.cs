	...
	where T : class
{
	...
	public Task<Stream> GetResponseStreamAsync() => GetResponseStreamAsync(CancellationToken.None);
	...
	public Task<IEnumerable<T>> ReadAsCollectionAsync() => ReadAsCollectionAsync(CancellationToken.None);

	public Task<IEnumerable<T>> ReadAsCollectionAsync(CancellationToken cancellationToken) => ReadAsCollectionAsync(null, CancellationToken.None);

	public Task<IEnumerable<T>> ReadAsCollectionAsync(ODataFeedAnnotations annotations) => ReadAsCollectionAsync(annotations, CancellationToken.None);
	...
	public Task<T> ReadAsSingleAsync() => ReadAsSingleAsync(CancellationToken.None);
	...
	public Task<U> ReadAsScalarAsync<U>() => ReadAsScalarAsync<U>(CancellationToken.None);
