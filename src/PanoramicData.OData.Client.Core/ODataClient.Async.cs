...
public partial class ODataClient
{
	...
	/// <param name="baseUri">The URL base of the OData service.</param>
	/// <returns>The service metadata.</returns>
	public static Task<T> GetMetadataAsync<T>(Uri baseUri) => GetMetadataAsync<T>(baseUri, null, CancellationToken.None);
	...
	/// <param name="cancellationToken">The cancellation token.</param>
	/// <returns>The service metadata.</returns>
	public static Task<string> GetMetadataDocumentAsync(Uri baseUri, CancellationToken cancellationToken) => GetMetadataDocumentAsync(baseUri, null, CancellationToken.None);
	...
	/// <param name="credentials">The OData service access credentials.</param>
	/// <returns>The service metadata.</returns>
	public static Task<string> GetMetadataDocumentAsync(Uri baseUri, ICredentials credentials) => GetMetadataDocumentAsync(baseUri, credentials, CancellationToken.None);
	...
	public Task<IEnumerable<IDictionary<string, object>>> FindEntriesAsync(string commandText) => FindEntriesAsync(commandText, false, null, null, CancellationToken.None);
	...
	public Task<int> DeleteEntriesAsync(string collection, string commandText) => DeleteEntriesAsync(collection, commandText, CancellationToken.None);
	...
	public Task LinkEntryAsync(string collection, IDictionary<string, object> entryKey, string linkName, IDictionary<string, object> linkedEntryKey) => LinkEntryAsync(collection, entryKey, linkName, linkedEntryKey, CancellationToken.None);
	...
	public Task<Stream> GetMediaStreamAsync(string commandText) => GetMediaStreamAsync(commandText, null, CancellationToken.None);

	public Task<Stream> GetMediaStreamAsync(string commandText, CancellationToken cancellationToken) => GetMediaStreamAsync(commandText, null, cancellationToken);

	public Task SetMediaStreamAsync(string commandText, Stream stream, string contentType, bool optimisticConcurrency) => SetMediaStreamAsync(commandText, stream, contentType, optimisticConcurrency, null, CancellationToken.None);

	public Task SetMediaStreamAsync(string commandText, Stream stream, string contentType, bool optimisticConcurrency, CancellationToken cancellationToken) => SetMediaStreamAsync(commandText, stream, contentType, optimisticConcurrency, null, cancellationToken);

	public Task<IDictionary<string, object>> ExecuteFunctionAsSingleAsync(string functionName, IDictionary<string, object> parameters) => ExecuteFunctionAsSingleAsync(functionName, parameters, CancellationToken.None);
	...
	public Task<T> ExecuteFunctionAsScalarAsync<T>(string functionName, IDictionary<string, object> parameters) => ExecuteFunctionAsScalarAsync<T>(functionName, parameters, CancellationToken.None);
	...
	public Task<T[]> ExecuteFunctionAsArrayAsync<T>(string functionName, IDictionary<string, object> parameters) => ExecuteFunctionAsArrayAsync<T>(functionName, parameters, CancellationToken.None);
	...
	public Task ExecuteActionAsync(string actionName, IDictionary<string, object> parameters) => ExecuteActionAsync(actionName, parameters, CancellationToken.None);
	...
	public Task<IEnumerable<IDictionary<string, object>>> ExecuteActionAsEnumerableAsync(string actionName, IDictionary<string, object> parameters) => ExecuteActionAsEnumerableAsync(actionName, parameters, CancellationToken.None);
	...
	public Task<T> ExecuteActionAsScalarAsync<T>(string actionName, IDictionary<string, object> parameters) => ExecuteActionAsScalarAsync<T>(actionName, parameters, CancellationToken.None);
	...
	public Task<T[]> ExecuteActionAsArrayAsync<T>(string actionName, IDictionary<string, object> parameters) => ExecuteActionAsArrayAsync<T>(actionName, parameters, CancellationToken.None);
	...
	public Task<ODataResponse> GetResponseAsync(ODataRequest request) => GetResponseAsync(request, CancellationToken.None);
	...
	public Task<Stream> GetResponseStreamAsync(ODataRequest request) => GetResponseStreamAsync(request, CancellationToken.None);

	public Task<Stream> GetResponseStreamAsync(ODataRequest request, CancellationToken cancellationToken) => ExecuteGetStreamRequestAsync(request, cancellationToken);
