...
namespace PanoramicData.OData.Client.Tests.Reflection
{
    public class MemberAccessorTests
    {
		...
		[Fact]
		public void ShouldGetStaticPropertyValue() => Assert.Equal(TestClass.StaticProperty, MemberAccessor.GetValue<string>(null, typeof(TestClass).GetProperty(nameof(TestClass.StaticProperty))));

		[Fact]
		public void ShouldGetStaticFieldValue() => Assert.Equal(TestClass.staticField, MemberAccessor.GetValue<string>(null, typeof(TestClass).GetField(nameof(TestClass.staticField))));
