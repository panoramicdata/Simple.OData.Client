...
namespace PanoramicData.OData.Client.Tests.Core
{
    public class RequestWriterV3Tests : RequestWriterTests
    {
		...
		protected async override Task<IRequestWriter> CreateRequestWriter() => new V3.Adapter.RequestWriter(_session, await _client.GetMetadataAsync<Microsoft.Data.Edm.IEdmModel>(), null);
	}
    ...
    public class RequestWriterV4Tests : RequestWriterTests
    {
		...
		protected async override Task<IRequestWriter> CreateRequestWriter() => new V4.Adapter.RequestWriter(_session, await _client.GetMetadataAsync<Microsoft.OData.Edm.IEdmModel>(), null);
	}
