...
using PanoramicData.OData.Client.V3.Adapter;
using Xunit;
...
namespace PanoramicData.OData.Client.Tests.Core
{
    public class ResponseReaderV3Tests : CoreTestBase
    {
		...
		[Fact]
		public Task GetColorsSchema() => ParseSchema("Colors");

		[Fact]
		public Task GetFacebookSchema() => ParseSchema("Facebook");

		[Fact]
		public Task GetFlickrSchema() => ParseSchema("Flickr");

		[Fact]
		public Task GetGoogleMapsSchema() => ParseSchema("GoogleMaps");

		[Fact]
		public Task GetiPhoneSchema() => ParseSchema("iPhone");

		[Fact]
		public Task GetTwitterSchema() => ParseSchema("Twitter");

		[Fact]
		public Task GetYouTubeSchema() => ParseSchema("YouTube");

		[Fact]
		public Task GetNestedSchema() => ParseSchema("Nested");

		[Fact]
		public Task GetArrayOfNestedSchema() => ParseSchema("ArrayOfNested");
