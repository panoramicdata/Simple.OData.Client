...
namespace PanoramicData.OData.Client.Tests.Core
{
    public class RequestWriterBatchV3Tests : RequestWriterBatchTests
    {
		...
		protected async override Task<IRequestWriter> CreateBatchRequestWriter() => new V3.Adapter.RequestWriter(
				_session,
    ...
    public class RequestWriterBatchV4Tests : RequestWriterBatchTests
    {
		...
		protected async override Task<IRequestWriter> CreateBatchRequestWriter() => new V4.Adapter.RequestWriter(
				_session,
