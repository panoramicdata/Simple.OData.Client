...
namespace PanoramicData.OData.Client.Tests.Core
{
    ...
    public class RequestWriterActionTests : CoreTestBase
    {
		...
		protected async Task<IRequestWriter> CreateRequestWriter() => new V4.Adapter.RequestWriter(_session, await _client.GetMetadataAsync<Microsoft.OData.Edm.IEdmModel>(), null);
